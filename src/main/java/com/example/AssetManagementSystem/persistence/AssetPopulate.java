...
public class AssetPopulate implements CommandLineRunner {
    ...
    var time=Arrays.asList(new Asset("laptop",sdf.parse("20-12-2022"),new BigDecimal(80000),new BigDecimal(40)),
            new Asset("tv",sdf.parse("22-2-2023"),new BigDecimal(56000),new BigDecimal(40)));
